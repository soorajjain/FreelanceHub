                    ...
                    <div className="py-6 px-3 mt-32 sm:mt-0">
                      ...
                      <div className="mr-4 text-center mt-[-30px] sm:mt-[100px] lg:mt-0">
                        ...
                        <span className="text-[16px] text-blueGray-600">
                          comes here,hey,hii,nodejs,react,external , bootsrao
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap justify-center">
                    <div className="w-full lg:w-9/12 px-4">
                      <p className="mb-4 text-lg leading-relaxed text-blueGray-700">
                       ...
                       <button
                        className=" mt-5 bg-pink-500 active:bg-pink-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150"
                        type="button"
                      >
                        Edit Profile
                      </button>
