        ...
        <div className="howitwork max-w-[1170px] mx-auto text-[#141C3A] flex justify-center items-center mt-8 flex-col mt-[50px]">
          <div className="flex flex-col gap-5 sm:mx-12  md:mx-12 lg:mx-auto mx-6 justify-center items-center">
            ...
            <h3 className="text-[16px] md:text-[20px] md:text-[20px] text-center w-[90%]">
              ...
              collaborate, making it easier than ever to find the right match
              for every project.
            </h3>
            ...
            <h3 className="text-[16px] md:text-[20px] md:text-[20px] text-center w-[90%]">
              ...
              forward-thinking businesses. Our platform caters to a wide range
              of industries, including technology, design, marketing, writing,
              and more.
            </h3>
            <h1 className="text-[28px] font-bold text-center mt-10">
              Our Mission
            ...
            <h3 className="text-[18px] text-center w-[90%] sm:mt-5 p-5  border border-[#141C3A] mb-14">
              ...
              talent, creativity, and the freedom to work your way. Whether
              you’re a freelancer looking for exciting opportunities or a
              business seeking top-notch talent, we’re here to help you succeed.
            </h3>
          </div>
        </div>
      </div>
