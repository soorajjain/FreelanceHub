    ...
    <div className="bg-[#F6F6F6]">
      <div className="Hero-sec max-w-[870px] h-[400px] grid grid-row-2 text-black sm:mx-12  md:mx-12 lg:mx-auto mx-10 md:grid-cols-2 items-center justify-center sm:flex-row">
        <div className="flex mx-auto items-center md:items-start flex-col justify-center order-2 gap-7">
          <div className="font-serif font-bold text-[28px] md:text-[40px] md:text-left">
            Sign In
          </div>
          <div className="text-[16px] md:text-[20px] w-[300px] text-center md:text-left ">
      ...
      <div className="Hero-sec max-w-[870px] h-[400px] grid grid-row-2 text-black sm:mx-12  md:mx-12 lg:mx-auto mx-6 md:grid-cols-2 items-center justify-center sm:flex-row mt-28 md:mt-0 ">
        <div className="flex mx-auto items-center md:items-start flex-col justify-center md:order-1 order-2 ">
          <div className="font-serif font-bold text-[28px] md:text-[40px] md:text-left text-center">
            Find the Job
          </div>
      ...
      <div className="Hero-sec max-w-[870px] h-[400px] grid grid-row-2 text-black sm:mx-12  md:mx-12 lg:mx-auto mx-6 md:grid-cols-2 items-center justify-center sm:flex-row mt-28 md:mt-0 ">
        <div className="flex mx-auto items-center md:items-start flex-col justify-center  order-2 ">
          <div className="font-serif font-bold text-[28px] md:text-[40px] md:text-left mt-3 text-center">
            Manage the Work
          </div>
          <div className="
          text-[16px] md:text-[20px] pt-4 w-[300px] text-center md:text-left">
