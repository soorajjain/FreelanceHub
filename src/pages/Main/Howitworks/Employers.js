  ...
  return (
    <div className="bg-[#F6F6F6]">
      <div className="Hero-sec max-w-[870px] h-[400px] grid grid-row-2 text-black sm:mx-12  md:mx-12 lg:mx-auto mx-10 md:grid-cols-2 items-center justify-center sm:flex-row">
        <div className="flex mx-auto items-center md:items-start flex-col justify-center order-2 md:order-1 gap-7">
          <div className="font-serif font-bold text-[28px] md:text-[40px] md:text-left text-black">
            Sign Up
          </div>
